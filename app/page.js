        ...
        <nav className="flex items-center space-x-6">
          {user ? (
            <>
              ...
              {/* Add Item Link - available to all users */}
              <Link 
                href="/add-item"
                className="text-green-700 hover:text-green-900 font-medium transition duration-300 ease-in-out"
              >
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex space-x-2">
                        <Link 
                          ...
                          className="flex-1 bg-green-500 text-white px-4 py-2 rounded-lg font-medium hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-75 transition duration-300 ease-in-out text-center"
                        >
                          View Details
                        </Link>
